...
if($userstatus >= 1){
   ...
   header("Location: updatepass.php?id=$userstatus");
}else{
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="forgot-password.php" method="post">
                    <div class="form-group">
                      <input type="email" name="exampleInputEmail" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                    </div>
