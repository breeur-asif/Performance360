	          ...
	          <div class="card shadow mb-4">
	            <div class="card-body">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-5">
					  <input id="textinput" name="textinput" type="text" placeholder="Session Title" class="form-control input-md">
					...
					<!--Table head-->
					  ...
					  <tbody>
					    ...
					    <select id="selectbasic" name="selectbasic" class="form-control">
					      ...
					      <td><input id="textinput" name="textinput" type="text" placeholder="Intensity" class="form-control input-md"></td>
					      <td><input id="textinput" name="textinput" type="text" placeholder="Recovery" class="form-control input-md"></td>
