...
<div class="row">
	...
	<div class="col-lg-1"> <div class="col-md-4"><button type="button" class="btn btn-success">List</button>
...
<div class="col-md-4"><button type="button" class="btn btn-primary">Save </button>
