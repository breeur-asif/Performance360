...
<body id="page-top">
  ...
  <div id="wrapper">
	...
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="formula.php">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">MSAA Swimming Competition(10/11/2019)</h1>
          </div>
...
</div></div>				  <div class="col-lg-3"><div class="card">
<h5 class="card-header">Featured</h5>
<div class="card-body">
<h5 class="card-title">Special title treatment</h5>
<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
	          ...
	          <div class="card shadow mb-12">
	            <div class="card-body">
							...
							<input type="text" name="name" value="">
									...
									<div class="col-md-4">
										<button type="button" class="btn btn-primary">Exercise Prescription </button>
									</div>
								</div>
								<div class="form-group row">
									<label class="col-md-2 control-label" for="selectbasic">Competation Name:</label>
									<div class="col-md-2">
<input type="text" name="name" value="">
</div><label class="col-md-6 control-label" for="selectbasic">(Like : Agility,training,plyometrice Sketches etc,)</label>
									<div class="col-md-2">
 									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-md-4">
<input type="text" name="name" value="">
</div><label class="col-md-2 control-label" for="selectbasic"></label>
									<div class="col-md-4">
								...
								<div class="form-group row">
									...
									<div class="col-md-2">
<input type="text" name="name" value="">
</div><label class="col-md-6 control-label" for="selectbasic">Add photo Option</label>
									<div class="col-md-2">
 									</div>
										...
										<div class="col-md-2">
	<input type="text" name="name" value="">
</div><label class="col-md-4 control-label" for="selectbasic">(Text)</label>
										<div class="col-md-4">
