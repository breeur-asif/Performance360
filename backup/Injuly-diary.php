...
<br>
				...
				<div class="card" style="width: 18rem;">
				 ...
				 <h2>   22/10/2019        </h2>               Anterior Cruciate Ligament</h2>
  ...
  <div class="card-header bg-info">
		<h2> 0/11/2019         </h2>                 Hamstring Pull
...
<div class="card" style="width: 18rem;">
  <div class="card-header bg-warning">
     <h2>12/12/2019                             </h2>
Delayed Onset Muscle Soreness  </div>
...
<div class="table-responsive">
  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    <tbody>
			...
			<tr>
				<th> Date of Injuly</th>
				<th>Output From the Client in frontend
</th>
				<th> </th>
