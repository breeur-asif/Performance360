  ...
  <li class="nav-item ">
        <a class="nav-link" href="questionform.php">
          <i class="fas fa-fw fa-question fa-2x text-gray-300"></i>
          <span>Questionnaier</span></a>
      </li>


        <li class="nav-item ">
        <a class="nav-link" href="client_MET.php">
          <i class="fas fa-fw fa-running fa-2x text-gray-300"></i>
          <span>MET</span></a>
      </li>  
    ...
    <li class="nav-item ">
      ...
      <li class="nav-item">
        <a class="nav-link" href="competition.php">
          ...
          <span>COMPETITION CALENDER </span></a>
      </li>
...
GOAL</span></a>
  ...
  <!--     <li class="nav-item">
        <a class="nav-link" href="sport_event.php">
          ...
          <span>SPORT EVENT DATABASE</span></a>
      </li> -->
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="center_reprt.php">
         <i class="far fa-clipboard fa-2x text-gray-300"></i>
          <span>REPORT CENTER</span></a>
      </li>
  <li class="nav-item">
