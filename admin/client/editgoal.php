...
$sql1 = "select * from goal where user_id = $user_id and term = $te"; 
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
                  ...
                  <table class="table table-bordered"  width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                         ...
                         <td> Goal</td>
                        <td> </td><td> 
                        <textarea  type="text" name="lname" id="s1at" /><?php echo $goal; ?> </textarea>
                         </td>
       ...
       <input type="hidden" name="goalid" value = '<?php  echo $goal_id  ?>' >
                        ...
                        <td> Deadline</td>
                        <td>Weeks / Months </td>
                        <td> <input type="date" id="lname" name="duration" value='<?php echo $duration ?>'></td>
                         </tr>
                    </tr>
                        <td> Reminder</td>
                        <td> How Frequently you want this to remind yourself</td>
                        ...
                        <td>Specific </td>
                        <td>What do you want to achieve in your sport? </td>
                        <td> 
                        <textarea  type="text" name="specfic"  /><?php echo $specfic; ?> </textarea>
                        
                        </td>
                         </tr>
                    </tr>
                        <td>Measurable </td>
                        <td>How will you know when you have achieved it? </td>
                        <td>
                        <textarea  type="text" name="measurable" id="s1at" /><?php echo $measurable; ?> </textarea>
                         
                           </td>
                         </tr>
                    </tr>
                        <td> Agreed</td>
                        <td> Do you and your coach agree on the goal?</td>
                        <td>
                       <textarea  type="text" name="agree"  /><?php echo $agree; ?> </textarea>   
                         
                           </td>
                         </tr>
                    </tr>
                        <td>Realistic </td>
                         <td> Are you just dreaming? -Why</td>
                         <td>
                      <textarea  type="text" name="realistic" /><?php echo $realistic; ?> </textarea>     
                          
                           </td>
                          </tr>
                    </tr>
                        <td>Time Based </td>
                        <td>When? Today? Tomorrow?  </td>
                        <td> 
                        <textarea  type="text" name="time_base" /><?php echo $time_base; ?> </textarea>
                        
                        </td>
                      </tr>
                       <tr>
                         <td>Exciting</td>
                         <td>Are the goals going to keep you motivated? </td>
                         <td> 
                      <textarea  type="text" name="excted" id="s1at" /><?php echo $excted; ?> </textarea>   
                        
                         </td> </tr>
                    </tr>
                        <td>Recorded </td>
                        <td> How and when will you do this? </td>
                        <td>
                        <textarea  type="text" name="recorded"  /><?php echo $recorded; ?> </textarea>  
                         
                           </td> </tr>
                    </tr>
                        <td> Strength ( Positive )</td>
                        <td> What are you good at?</td>
                        <td>
                      <textarea  type="text" name="strength_pos" /><?php echo $strength_pos; ?> </textarea>   
                            
                           </td> </tr>
                    </tr>
                        <td>Weaknesses ( Negative )</td>
                        <td>What area do you need to develop?</td> 
                  <td>
                     <textarea  type="text" name="weaknesses_neg" /><?php echo $weaknesses_neg; ?> </textarea>
                     <!--<input type="text"  name="weaknesses_neg" value='<?php echo $weaknesses_neg ?>'>-->
                     </td> </tr>
                    </tr>
                        <td>Opportunities ( Position ) </td>
                        <td>What opportunities available to you? </td>
                        <td>
                         <textarea  type="text" name="opp_pos" /><?php echo $opp_pos; ?> </textarea>  
                           <!--<input type="text"  name="opp_pos" value='<?php echo $opp_pos ?>'>-->
                           </td>
                      </tr>
                      <tr>
                        <td>Threats ( Negative )</td>
                         <td>What factors are there that may be a barrier to you achieving this goal?</td><td> 
                        <textarea  type="text" name="threats_neg" /><?php echo $threats_neg; ?> </textarea>  
