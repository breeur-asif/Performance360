    ...
    <form>
     <!--new page -->
		 <div class="form-group row">
			 ...
			 <label class="col-md-2 control-label" for="selectbasic">Duration</label>
			 <label class="col-md-2 control-label" for="selectbasic">Engery</label>
			 <label class="col-md-2 control-label" for="selectbasic"></label>
		 </div><!-- heading table-->
		 <div class="form-group row">
			 <label class="col-md-2 control-label" for="selectbasic">1</label>
			 <div class="col-md-4">
				 <div class="dropdown">
	    ...
	    <ul class="dropdown-menu">
	      ...
	      <li><a href="#">JavaScript</a></li>
			 ...
			 <div class="col-md-2>Engery</div>
			 <div class="col-md-2></div>
		 </div><!--1-->
		 <div class="form-group row">
			<label class="col-md-2 control-label" for="selectbasic">2</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		...
		<div class="form-group row">
			<label class="col-md-2 control-label" for="selectbasic">3</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		...
		<div class="form-group row">
			<label class="col-md-2 control-label" for="selectbasic">4</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		...
		<div class="form-group row">
			<label class="col-md-2 control-label" for="selectbasic">5</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		 <ul class="dropdown-menu">
			...
			<label class="col-md-2 control-label" for="selectbasic">6</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		 <ul class="dropdown-menu">
			...
			<label class="col-md-2 control-label" for="selectbasic">7</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		 <ul class="dropdown-menu">
			...
			<label class="col-md-2 control-label" for="selectbasic">8</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		...
		<div class="form-group row">
			<label class="col-md-2 control-label" for="selectbasic">9</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		 <ul class="dropdown-menu">
			...
			<label class="col-md-2 control-label" for="selectbasic">10</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		...
		<div class="form-group row">
			<label class="col-md-2 control-label" for="selectbasic">11</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
		...
		<div class="form-group row">
			<label class="col-md-2 control-label" for="selectbasic">12</label>
			<div class="col-md-4">
				<div class="dropdown">
		 <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
		 <span class="caret"></span></button>
...
<div class="form-group row">
	...
	<label class="col-md-4 control-label" for="selectbasic">Balance</label>
	<div class="col-md-2">  </div>
	<label class="col-md-2 control-label" for="selectbasic">Engery</label>
...
<div class="form-group row">
	...
	<label class="col-md-4 control-label" for="selectbasic">Total 24 Hours /1400</label>
	<div class="col-md-2"> 			<input type="text" name="" value="">
 </div>
	<div class="col-md-2"> 			<input type="text" name="" value="">
 </div>
