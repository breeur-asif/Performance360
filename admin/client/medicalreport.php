...
$target_file1 =  $target_dir1 . $_SESSION["id"] . 'rep'. $randomid . "." . $imageFileType;

$medical_report = $_POST['medical_report'];
  $file_upload = $target_file1;

  $start_date = $_POST['start_date'];
 

$sql= "INSERT INTO `medical_report`(`medical_report`,`user_id`,`byadmin`, `file_upload`, `start_date`, `cr_date`) VALUES ('$medical_report','".$_SESSION["id"]."',1,'$file_upload','$start_date',now()) ";
...
<div class="card  getdata1  " style="width: auto;">
 <div class="card-header bg-warning">
    <h5> Schedule a Medical Test For Client </h5>
  </div>
