...
if($_GET['u_idl']){
 ...
 $sql = "SELECT u.*,p.weight,p.height FROM users u  left JOIN profile_details p ON p.user_id = u.id  where u.id = '".$_GET['u_idl']."' ";
  
}else{

  $sql = "SELECT u.*,p.weight,p.height FROM users u  left JOIN profile_details p ON p.user_id = u.id  where u.id = '".$_SESSION['id']."' ";
                                           ...
                                           <form id='profilesport'>
                                                   ...
                                                   <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                                      ...
                                                                      <input type="text" class="form-control" name="height" id="height" value="" required>
                                                        </div>
                                                      </div>
...
$(".addmore").on('click',function(){
  count=$('table tr').length;
    ...
    data +="<td><select id='Medications"+i+"' name='Medications[]' class='dynamictable'><option value='Medications'>Medications</option>  <option value='Supplements'>Supplements</option> <option value='Vitamins'>Vitamins </option> <option value='Inhaler'>Inhaler</option><option value='Birthcontrol'>Birth control</option><option value='Hormones'>Hormones</option></select><td><input class='dynamictable' type='text' id='first_name"+i+"' name='first_name[]'/></td> <td><input class='dynamictable' type='text' id='last_name"+i+"' name='Dosage[]'/></td><td><input class='dynamictable' type='text' id='tamil"+i+"' name='Times[]'/></td></tr>";
  $('table').append(data);
  i++;
});
