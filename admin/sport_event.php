...
if (isset($_POST['submit'])) {
 ...
 $sport_name = $_POST['sport_name'];
  ...
  $parameter = $_POST['parameter'];
   ...
   $unit_measuring = $_POST['unit_measuring'];

 $eventput = $input_unit .' '.$unit_measuring.' '.$event;



 $sql = "INSERT INTO `sport_event`( `sport`, `event` ) VALUES ('$sport_name','$eventput')";
...
<option value="Weight">Weight</option>
                ...
                <div class="col-md-10">
 <input type="text" name="input_unit" value="">
  ...
  <option value="grams">grams</option>
                 ...
                 <select style="margin-top: 10px;text-align: center;  display: none; " name="unit_measuring" id="Unit_distance" >
  <option value="">Parameter </option>
  ...
  <option value="km">km</option>
    ...
    <div class="col-md-12">	    <button type="submit" class="btn btn-primary" name="submit">Save</button>
