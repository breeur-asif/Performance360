...
?> 
                      <tr>
                        <td><a href="client/index.php?adi=<?php echo $row['id']; ?>;"> <?php echo $row['fname'] . $row['lname'] ?> </a></td>
                        ...
                        <td><button class="btn btn-primary" onclick="location.href='client/viewprofile.php?u_idl=<?php echo $row['id']; ?>';" >view Profile</button></td>
                      </tr>
