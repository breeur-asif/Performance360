...
<div class="loader"></div>
    ...
    <form>
     <!--new page -->
		 <div class="form-group row">
	 		<label class="col-lg-6 control-label" for="selectbasic">Name of the Test:</label>
	 		<div class="col-lg-6">
	 <input type="text" name="name" id="name" value="" >
		...
		<div class="form-group row">
 		<label class="col-lg-6 control-label" for="selectbasic">Description:</label>
 		<div class="col-lg-6">
  <input type="text" name="Description" value="" >
	...
	<div class="form-group row">
	 <label class="col-lg-6 control-label" for="selectbasic">Protocol:</label>
	 <div class="col-lg-6">
<input type="text" name="Protocol" value="">
 ...
 <div class="form-group row">
	<label class="col-lg-6 control-label" for="selectbasic">Unit:</label>
	<div class="col-lg-6">
...
<div class="form-group row">
 <label class="col-lg-6 control-label" for="selectbasic">Normal Value:</label>
 <div class="col-lg-6">
...
<div class="form-group row">
 <label class="col-lg-6  control-label" for="selectbasic">Male:</label>
 <div class="col-lg-6">
...
<div class="form-group row">
 <label class="col-lg-6  control-label" for="selectbasic">Female:</label>
 <div class="col-lg-6">
<input type="text" name="Female" value="">
 </div>
 <label class="col-lg-6  control-label" for="selectbasic"></label>
 <div class="col-lg-6">
 </div>
</div>
<div class="form-group row">
 <label class="col-lg-6  control-label" for="selectbasic">Children:</label>
 <div class="col-lg-6">
...
<!-- button -->
<div class="form-group row">
 <label class="col-lg-6  control-label" for="selectbasic">High Value Means: </label>
 <div class="col-lg-6">
...
<div class="form-group row">
 <label class="col-lg-6  control-label" for="selectbasic">Low Value Means:</label>
 <div class="col-lg-6">
<input type="text" name="lowvaluemean" value="">
 </div>
  </div>
 <div class="text center"><button type="button" class="btn btn-primary" id="save">Save </button>
