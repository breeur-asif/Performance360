...
$sql= "INSERT INTO `exercise`(`exercise_name`, `exercise_group`, `major_body_part`, `report_file`, `description`) VALUES ('$exercise_name',' $exercise_group','$major_body_part','$report_file',' $description ')";
            ...
            <div class="col-lg-6 mb-6">    
	          <form action="1.php" method="post">
                                                     <div class="form-group row">
                                                             ...
                                                             <div class="col-md-6">
                                                               <label for="first_name"><h6>Exercise Name: </h6></label></div>
                                                               <div class="col-md-6">
                                                   ...
                                                   <div class="form-group row">
                                                      ...
                                                      <div class="col-md-6">
                                                        <label for="dob"><h6>Exercise Group :</h6></label></div>
                                                        <div class="col-md-6">
                                                        <input type="text" class="form-control" name="exercise_group" value="" >
                                                        <label> (Like: Agility Training, Plyometrics, Stretches etc.)
	         ...
	         <div class="col-lg-6 mb-6 text-center">   
	          <button type="button" class="btn btn-info"><a href="exercise_prescription_main.php">Exercise Database</a></button><br><br>
