...
<head>
  ...
  <title>Select Exercise Prescription</title>
          ...
          <div class="row">
            ...
            <input id="trainingphase" name="trainingphase" type="hidden" >
					...
					<div class="form-group">
					  ...
					  <div class="col-md-5">
					    <select id="selectbasic" name="Colour" class="form-control" value="<?php echo $session_color ?>">
...
<?php endwhile; ?> 
         ...
         <center>  <button type="button" name='save' id='save_btn' value="Save"> SAVE</button></center>
