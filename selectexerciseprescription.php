          ...
          <div class="row">
              ...
              <form id='excercise'>
	            <div class="card-body">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-5">
					  <input id="Title" name="Title" type="text" placeholder="Session Title" class="form-control input-md" value="<?php echo $session_title ?>" readonly>
            <input id="trainingphase" name="trainingphase" type="hidden" >
					...
					<div class="form-group">
					  ...
					  <div class="col-md-5">
					    <select id="selectbasic" name="Colour" class="form-control"  disabled="disabled">
...
<?php endwhile; ?> 
					    ...
					    <select id="Sets" name="Sets" class="form-control" value="<?php echo $sets_1 ?>" disabled="disabled">
					      <option value="1">1</option>
					      <option value="2">2</option>
					      <option value="3">3</option>
					    </select></td>
					      <td>
					    <select id="Reps" name="Reps" class="form-control" value="<?php echo $rep_1 ?>" disabled="disabled">
					      <option value="1">1</option>
					      <option value="2">2</option>
					      <option value="3">3</option>
					    </select></td>
					      <td><input id="Intensity" name="Intensity" type="text" placeholder="Intensity" class="form-control input-md" value="<?php echo $intensity ?>" readonly></td>
					      <td><input id="Recovery" name="Recovery" type="text" placeholder="Recovery" class="form-control input-md" value="<?php echo $recovery ?>" readonly></td>
         ...
         <center>  <a href="exerciseprescription.php" class="btn btn-primary"> Back</a></center>
