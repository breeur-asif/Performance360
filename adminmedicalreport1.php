...
<div class="col-lg-9">
				...
				<div class="row">
				 ...
				 <h2> 2 option ,upload a file (pdf or image) or camera  will be Active
...
<div class="form-group row">
												<label class="col-md-2 control-label" for="selectbasic">Send a Nofication/Reminder to client about the medical test:</label>
												<div class="col-md-10">
											<input type="text" name="name" value="">
												</div>
											</div>
  ...
  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <thead>
      <tr>
        ...
        <th>Test Name </th>
        <th>Unit</th>
        <th>Normal Male  Value</th>
		<th>Normal Famale  Value</th>
<th>Normal Children  Value</th>
